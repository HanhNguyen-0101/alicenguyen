...
import { addSubCategoryRequest } from "../../redux/actions/subCategory.action";
...
export const AddSubCategoryForm: React.FC<{}> = (props: any) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      dispatch(addSubCategoryRequest(callbackObj(values, callback("Inside callback after add subCategory"))));
    },
  });
