...
import { addContactRequest } from "../../redux/actions/contact.action";

export const AddContactForm: React.FC<{}> = (props: any) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      dispatch(addContactRequest(callbackObj(values, callback("Inside callback after add contact"))));
    },
  });
