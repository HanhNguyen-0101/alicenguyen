...
import { addOrganizationRequest } from "../../redux/actions/organization.action";

export const AddOrganizationForm: React.FC<{}> = (props: any) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      dispatch(addOrganizationRequest(callbackObj(values, callback("Inside callback after add organization"))));
    },
  });
