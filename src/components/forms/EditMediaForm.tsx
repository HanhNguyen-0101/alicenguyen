...
import { editMediaRequest } from "../../redux/actions/media.action";
...
export const EditMediaForm: React.FC<{ media: IMediaModel }> = ({ media }) => {
      ...
      for (let key in values) {
        switch (key) {
          case "src":
            ...
            break;
          case "enabled": formData.append("enabled", JSON.stringify(values.enabled)); break;
          case "subCategoryId": formData.append("subCategoryId", values.subCategoryId); break;
          case "title": formData.append("title", values.title); break;
          case "description": formData.append("description", values.description); break;
          default: break;
        }
      }
      dispatch(editMediaRequest(callbackObj(values, callback("Inside callback after edit media"))));
    },
  });
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        {imgSrc && (
          <img alt="img" src={imgSrc} className="w-auto my-3" />
        )}
      </Form.Item>
      <Form.Item
