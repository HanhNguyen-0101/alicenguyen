...
import { editSkillRequest } from "../../redux/actions/skill.action";
import { callback, callbackObj } from "../global/Global";
import { ISkillModel } from "../../redux/types/skill.type";

export const EditSkillForm: React.FC<{skill:ISkillModel}> = ({skill}) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      dispatch(editSkillRequest(callbackObj(values, callback("Inside callback after edit skill"))));
    },
  });
