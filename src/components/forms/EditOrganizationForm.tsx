...
import { editOrganizationRequest } from "../../redux/actions/organization.action";
import { IOrganizationModel } from "../../redux/types/organization.type";

export const EditOrganizationForm: React.FC<{ organization: IOrganizationModel }> = ({ organization }) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      dispatch(editOrganizationRequest(callbackObj(values, callback("Inside callback after edit organization"))));
    },
  });
