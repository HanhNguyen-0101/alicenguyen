...
import { editBlogRequest } from "../../redux/actions/blog.action";
...
export const EditBlogForm: React.FC<{blog: IBlogModel}> = ({blog}) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      dispatch(editBlogRequest(callbackObj(values, callback("Inside callback after edit blog"))));
    },
  });
